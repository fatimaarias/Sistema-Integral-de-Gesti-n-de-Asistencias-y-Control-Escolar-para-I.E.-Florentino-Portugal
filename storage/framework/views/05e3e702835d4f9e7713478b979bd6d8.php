                        ...
                        <?php $__currentLoopData = $secciones; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $seccion): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="col">
                                <div class="grade-card h-100">
                                    ...
                                    <a href="<?php echo e(route('asistencias.verSolo', ['grado' => $grado->id, 'seccion' => $seccion->id])); ?>"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\1\Siscontrolasistencia2\resources\views/asistencias/seleccionar.blade.php ENDPATH**/ ?>